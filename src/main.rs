...
/// corresponding point on the complex
///
...
fn pixel_to_point(
    ...
    Complex {
        ...
        im: upper_left.im - pixel.1 as f64 * height / bounds.1 as f64, // Why subtration here? pixel.1 increases as we go down,
...
/// arguments specify points on the complex place corresponding to the upper-
